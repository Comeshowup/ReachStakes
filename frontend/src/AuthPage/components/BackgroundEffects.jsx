    ...
    return (
        <>
            ...
            <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
                ...
                <motion.div
                    className={cn("absolute top-[-10%] left-[-10%] w-[600px] h-[600px] rounded-full mix-blend-screen blur-[100px] opacity-20 will-change-transform", isBrand ? "bg-indigo-600" : "bg-emerald-600")}
                    animate={{
                        scale: [1, 1.05, 1],
                ...
                />
                <motion.div
                    className={cn("absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] rounded-full mix-blend-screen blur-[100px] opacity-10 will-change-transform", isBrand ? "bg-indigo-600" : "bg-cyan-600")}
                    animate={{
                        scale: [1, 1.1, 1],
