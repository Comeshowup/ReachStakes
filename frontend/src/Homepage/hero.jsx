...
function Hero() {
    ...
    const handleBrandClick = () => {
        navigate("/auth?role=brand&mode=signup");
    };

    const handleCreatorClick = () => {
        navigate("/auth?role=creator&mode=signup");
    };
                ...
                <div className="relative z-10 container mx-auto px-4 text-center">
                    ...
                    >
                        ...
                        <button
                            ...
                            className="px-8 py-4 rounded-full bg-white/10 border border-white/20 text-white font-semibold hover:bg-white/20 transition-colors backdrop-blur-sm"
                        >
                            I'm a Creator
                        </button>
                    </motion.div>
